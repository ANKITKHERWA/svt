...
function Hero() {
  return (
    <>
      <div
        className="bg-[url(/assest/png/1st.png)] bg-no-repeat bg-[length:100%_100%] z-10 overflow-hidden"
        id="Hero">
        <Navbar />
        <div className="max-w-[1775px] mx-auto px-4 md:px-6 lg:px-7 xl:px-25 lg:pt-15 pt-6 bg-gradient-to-t from-[#003423] to-[rgba(0,52,35,0)] ">
          <div className="flex lg:flex-row flex-col-reverse justify-center items-center  lg:gap-4 gap-2 relative  ">
            <div
              ...
              data-aos="fade-right">
              <Heading
                title="Turn sports knowledge into profit"
                className="text-[#fff] lg:text-5xl md:text-4xl sm:text-3xl text-[25px] ff-black  opacity-[0.8] leading-[120%]"
              />
              <SubHeading
                title="Trade crypto tokens representing professional athletes. Profit when the athletes perform in real life. Join the community now to participate in free token airdrops."
